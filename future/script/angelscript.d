...
immutable auto ANGELSCRIPT_VERSION = 23100;
immutable auto ANGELSCRIPT_VERSION_STRING = "2.31.0";
...
immutable bool AS_64BIT_PTR = true;

alias asFUNCTION_t = extern(C++) void function();
alias asGENFUNC_t  = extern(C++) void function (asIScriptGeneric*);
alias asALLOCFUNC_t  = extern(C++) void* function (size_t);
alias asFREEFUNC_t = extern(C++) void function (void*);

alias asCLEANENGINEFUNC_t   = extern(C++) void function (asIScriptEngine *);
alias asCLEANMODULEFUNC_t   = extern(C++) void function (asIScriptModule *);
alias asCLEANCONTEXTFUNC_t  = extern(C++) void function (asIScriptContext *);
alias asCLEANFUNCTIONFUNC_t = extern(C++) void function (asIScriptFunction *);
alias asCLEANTYPEINFOFUNC_t = extern(C++) void function (asITypeInfo *);
alias asCLEANSCRIPTOBJECTFUNC_t = extern(C++) void function (asIScriptObject *);
...
immutable bool AS_CAN_USE_CPP11 = false;
