...
//bool tryParseFloat (ref string s, ref float v) {
//    try { v = parse!float(s); }
...
//private bool parseVertex (ref string s, ref Array!vec4 verts) {
...
//    // Accept 3 or 4 floats
//    if (s.tryParseFloat(v.x) && s.tryParseFloat(v.y) && s.tryParseFloat(v.z)) {
//        s.tryParseFloat(v.w);

//        return verts ~= v, true;
//    } else {

//        // return false to signal parse error, but push 4 nans so we can continue as normal.
//        return verts ~= v, false;
//    }
//}
//unittest {
//    import std.algorithm: equal;
